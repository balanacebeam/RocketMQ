 ...
 * @since 2016-3-15
 */
public class DisruptorIndexService {
    ...
    public DisruptorIndexService(final DefaultMessageStore store) {
    ...
    public void indexRequest(List<DispatchRequest> dispatchRequestList) {
        this.buildIndex(dispatchRequestList);
    }

    public void buildIndex(final List<DispatchRequest> dispatchRequestList) {
        boolean breakdown = false;
        IndexFile indexFile = retryGetAndCreateIndexFile();
        if (indexFile != null) {
            long endPhyOffset = indexFile.getEndPhyOffset();
            MSG_WHILE: for (DispatchRequest msg : dispatchRequestList) {
        ...
        if (indexFile == null) {
            ...
            if (indexFile != null) {
                ...
                Thread flushThread = new Thread(new Runnable() {
                    @Override
                    public void run() {
                        DisruptorIndexService.this.flush(flushThisFile);
                    }
